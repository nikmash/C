...
#include <stdlib.h>
/*
The node struct has a pointer to data (the data that it holds) and a pointer to a next node. 
*/
...
/*
Creates a node with the given data and a pointer to the next node is set at NULL to begin with.
*/

listNode *nodeCreate(void* data, listNode *next);

/*
Destroys a node and the data pointer that is within it.
*/
...
listNode *SLInsert(SortedListPtr list, void *newObj, char *filename);
